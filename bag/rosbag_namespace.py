...
if __name__ == "__main__":
    ...
    input_bag_path = '/root/catkin_ws/src/bag/robot2_2024-01-13-09-49-21.bag'  # 원본 bag 파일 경로
    output_bag_path = '/root/catkin_ws/src/bag/robot2.bag'  # 결과 bag 파일 경로
    namespace = 'robot2'  # 추가할 네임스페이스
